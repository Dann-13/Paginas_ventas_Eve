                    ...
                    <div className='col-span-1 md:col-span-2 flex flex-col md:flex-row gap-5 items-center justify-between'>
                        ...
                        {isAuthenticated ? (
                            ...
                            <div className='flex items-center gap-2'>
                                 <Link className='font-veneer cursor-pointer text-white text-xl hover:border-b-4' to='/'>Ordenar Ahora</Link>
                                 <Link className='font-veneer cursor-pointer text-white text-xl hover:border-b-4' to='/profileUser'>Perfil</Link>
